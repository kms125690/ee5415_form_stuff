    ...
    public void onCheckboxClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.cb_addidas:
                if (checked)
                    Toast.makeText(MainActivity.this, "Addida Selected", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(MainActivity.this, "Addida Unselected", Toast.LENGTH_SHORT).show();
                break;
            case R.id.cb_nike:
                if (checked)
                    Toast.makeText(MainActivity.this, "Nike Selected", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(MainActivity.this, "Nike Unselected", Toast.LENGTH_SHORT).show();
                break;
        }
    }
        ...
        togglebutton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (togglebutton.isChecked()) {
                    ...
                    Toast.makeText(MainActivity.this, "Toggle Button Not checked", Toast.LENGTH_SHORT).show();
                }
            }
        });
